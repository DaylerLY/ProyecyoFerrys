...
typedef struct{
    int code, express, prior, horLleg; // codigo de identificacion / Se monta en un Ferry express o no [0 o 1] / prrioritario [0 o 1] / Hora de llegada
...
typedef struct{
    char nomb[50];
    int maxCap[4]; //maximas capacidades: Vehiculos, Pasajeros ejecutivos, Pasajeros VIP
    float cargaMax;
    int tiempViaje;
